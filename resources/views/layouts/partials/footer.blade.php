                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="subscriber-form-area">
                        <form action="#" class="subsriber-form">
                            ...
                            <input type="email" name="subscriber-mail" id="subscriber-mail" placeholder="Entrer un mail">
                ...
                <div class="col-md-5 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-footer-widget footer-about">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-envelope"></i> <a href="mailto:backpiper.com@gmail.com">backpiper.com@gmail.com</a></li>
